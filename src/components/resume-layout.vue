            ...
            <section class="resume-section" id="about">
                <div class="content-box">
                    ...
                    <h3 class="sub-title-name mb-3">#329-1, Nandagokula, 5th cross, Shanabag layout, Yamalur Bengaluru – 560037
                        Karnataka, India
                        <br/>
                        <!-- <span>hareeshcs33@gmail.com</span>
                        <span>+91 7259950413</span> -->
                    </h3>
                    <p class="lead">Frontend developer with over 3 plus years of experience developing
                        Web Applications.
                    </p>
                    <p class="lead"></p>
